module l2_tlb(input clk,input rst_n,input flush,input lookup_en,input [14:0] vpn_in,input write_en,input [14:0] write_vpn,input [15:0] write_pfn,output reg hit,output reg [15:0] pfn_out);


localparam ENTRIES=24;
